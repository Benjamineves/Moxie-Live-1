...
| [`moxie_digital_scheduler_spec.md`](moxie_digital_scheduler_spec.md) | **Proposed, not built** (2026-09-15). The daily cron: tier reconciliation, transfer-buyer window, dormancy, expiry reminders | New; decisions open in its §12 |
